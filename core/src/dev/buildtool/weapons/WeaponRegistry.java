...
public class WeaponRegistry {
    ...
    public static final Weapon MISSILE_LAUNCHER=new MissileLauncher(50,3,10,SpaceOfChaos.INSTANCE.missileTexture,"Missile launcher",SpaceOfChaos.INSTANCE.missileLauncherTexture, 200000,null);
