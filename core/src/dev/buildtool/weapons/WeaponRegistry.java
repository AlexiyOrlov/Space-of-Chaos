...
public class WeaponRegistry {
    ...
    public static final Weapon CLUSTER_GUN=new ClusterGun(20,1.5f,20,SpaceGame.INSTANCE.redProjectileTexture, "Cluster gun",SpaceGame.INSTANCE.clusterGunTexture, 100000,SpaceGame.INSTANCE.blasterSound);
    static {
