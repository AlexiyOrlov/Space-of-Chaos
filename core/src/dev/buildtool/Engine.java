...
public class Engine extends Item{
    ...
    public static final Engine MARK2=new Engine("mark2",6,70,400,0.03f,SpaceGame.INSTANCE.engine3Texture,35000);
    public static final Engine ENGINE_3=new Engine("mark3",7,80,400, 0.03f,SpaceGame.INSTANCE.engine2Texture,70000);
