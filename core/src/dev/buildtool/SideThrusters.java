...
public class SideThrusters extends Item{
    ...
    public static final SideThrusters SLOW=new SideThrusters(0.02f, 2f,"Slow thrusters", SpaceOfChaos.INSTANCE.thrusters1Texture, 3000);
    public static final SideThrusters BASIC=new SideThrusters(0.03f, 3f,"Basic thrusters", SpaceOfChaos.INSTANCE.thrusters2Texture, 4000);
