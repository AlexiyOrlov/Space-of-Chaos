...
public class SpaceGame extends Game {
	...
	public void create () {
		...
		assetManager.load("cash64.png", Texture.class);
		...
		assetManager.load("engine1.png", Texture.class);
		assetManager.load("engine2.png", Texture.class);
		assetManager.load("engine3.png", Texture.class);
		assetManager.load("ship icon.png", Texture.class);
		assetManager.load("ship icon2.png", Texture.class);
		assetManager.load("slot 2.png",Texture.class);
		...
		assetManager.load("ship icon2.png", Texture.class);
		assetManager.load("hull2.png", Texture.class);
		assetManager.load("bumblebee hull.png", Texture.class);
		assetManager.load("trading hull2.png",Texture.class);
		assetManager.load("pirate hull2.png", Texture.class);
		assetManager.load("pirate hull3.png", Texture.class);
		...
		engine1Texture=assetManager.get("engine1.png");
		engine2Texture=assetManager.get("engine2.png");
		engine3Texture=assetManager.get("engine3.png");
		slotTexture3=assetManager.get("slot 2.png");
		...
		shipIcon3=assetManager.get("ship icon2.png");
		blackHullTexture=assetManager.get("hull2.png");
		blackHull2Texture=assetManager.get("bumblebee hull.png");
		pirateHull3Texture=assetManager.get("pirate hull3.png");
		basicGunTexture=assetManager.get("basic gun.png");
		machineGunTexture=assetManager.get("machine gun.png");
		...
		shipIcon=assetManager.get("ship icon.png");
		ship2icon=assetManager.get("ship icon2.png");
		tradingHull2Texture=assetManager.get("trading hull2.png");
		pirateHull2Texture=assetManager.get("pirate hull2.png");
		battleHull3Texture=assetManager.get("battle hull 3.png");
